...
r2_score_print = r2_score(y_test,y_pred)
print("r2_score :",r2_score_print)

mean_absolute_error_print = mean_absolute_error(y_test,y_pred)
print("mean_absolute_error :",mean_absolute_error_print)

mean_absolute_error_print = mean_squared_error(y_test,y_pred)
print("mean_squared_error :",mean_absolute_error_print)

mean_root_mean_squared_error_print = mean_squared_error(y_test,y_pred)
print("mean_root_mean_squared_error :",mean_root_mean_squared_error_print)